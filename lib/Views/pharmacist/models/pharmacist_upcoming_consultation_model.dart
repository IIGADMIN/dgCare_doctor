...
//
//     final serviceProviderPharmacistUpcomingConsultationModel = serviceProviderPharmacistUpcomingConsultationModelFromJson(jsonString);

import 'dart:convert';

PharmacistUpcomingConsultationModel serviceProviderPharmacistUpcomingConsultationModelFromJson(String str) => PharmacistUpcomingConsultationModel.fromJson(json.decode(str));

String serviceProviderPharmacistUpcomingConsultationModelToJson(PharmacistUpcomingConsultationModel data) => json.encode(data.toJson());

class PharmacistUpcomingConsultationModel {
    bool? status;
    String? message;
    UpcomingConsultationPharmacistData? data;

    PharmacistUpcomingConsultationModel({
        this.status,
        this.message,
        this.data,
    });

    factory PharmacistUpcomingConsultationModel.fromJson(Map<String, dynamic> json) => PharmacistUpcomingConsultationModel(
        status: json["status"],
        message: json["message"],
        data: json["data"] == null ? null : UpcomingConsultationPharmacistData.fromJson(json["data"]),
    );
...
class UpcomingConsultationPharmacistData {
    List<UpcomingConsultationPharmacistListData>? upcomingConsultation;

    UpcomingConsultationPharmacistData({
        this.upcomingConsultation,
    });

    factory UpcomingConsultationPharmacistData.fromJson(Map<String, dynamic> json) => UpcomingConsultationPharmacistData(
        upcomingConsultation: json["upcomingConsultation"] == null ? [] : List<UpcomingConsultationPharmacistListData>.from(json["upcomingConsultation"]!.map((x) => UpcomingConsultationPharmacistListData.fromJson(x))),
    );
...
class UpcomingConsultationPharmacistListData {
    int? assignId;
    int? bookScheduleId;
    int? roleId;
    int? providerId;
    ...
    factory UpcomingConsultationPharmacistListData.fromJson(Map<String, dynamic> json) => UpcomingConsultationPharmacistListData(
