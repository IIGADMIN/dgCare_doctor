...
class PharmacistProfileWidgets {
  BuildContext context;

  PharmacistProfileWidgets({required this.context});
      ...
      child: Container(
        ...
        child: Card(
          ...
          child: showNetworkImageWithCached(
              imageUrl: imageUrl, height: 150, width: 150, radius: 10),
        ),
      ),
    );
  }

  Widget userDetailsItemView(
    String title,
    String name,
  ) {
    return Card(
  ...
  Widget nurseDetailsView() {
    return Consumer<PharmacistDetailsProvider>(
...
class FullScreenImageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: showNetworkImageWithCached(
          imageUrl: imageUrl,
