...
import 'package:healthcaredoctor2050/utils/styles/image_style.dart';
...
import 'package:healthcaredoctor2050/views/pharmacist/views/screens/profile/pharmacist_profile_screen.dart';
...
class PharmacistHomeWidgets {
  BuildContext context;

  PharmacistHomeWidgets({required this.context});
  ...
  Widget nurseDetailsHomeView() {
    ...
    return Consumer<PharmacistDetailsProvider>(builder: (c, data, w) {
      return InkWell(
        onTap: () {
          ...
          child: Row(
            children: [
              showNetworkImageWithCached(
                  imageUrl: pharmacistImageUrl + data.getUserProfilePic,
                  height: height / 8,
                  width: width / 3.5,
                  radius: 5),
              10.width,
