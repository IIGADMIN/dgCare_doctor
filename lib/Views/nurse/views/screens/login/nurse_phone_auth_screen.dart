...
import '../../../controllers/providers/login/nurse_auth_provider.dart';
import 'nurse_phone_otp_screen.dart';

class NursePhoneAuthScreen extends StatefulWidget {
  final String title;
  final String imagePath;
  final String profileType;

  const NursePhoneAuthScreen(
      {Key? key,
      required this.title,
  ...
  @override
  _NursePhoneAuthScreenState createState() => _NursePhoneAuthScreenState();
}

class _NursePhoneAuthScreenState extends State<NursePhoneAuthScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final authProvider = Provider.of<NurseAuthProvider>(context, listen: false);
