...
import 'package:healthcaredoctor2050/widgets/100ms/common/bottom_sheets/participants_bottom_sheet.dart';
...
import 'package:healthcaredoctor2050/widgets/100ms/common/bottom_sheets/audio_settings_bottom_sheet.dart';
import 'package:healthcaredoctor2050/widgets/100ms/common/bottom_sheets/meeting_mode_bottom_sheet.dart';
...
class _MoreSettingsBottomSheetState extends State<MoreSettingsBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    MeetingModeProvider meetingModeProvider = Provider.of<MeetingModeProvider>(context,listen: false);
              ...
              Expanded(
                child: ListView(
                  children: [
                    ...
                    meetingModeProvider.isAudioOnly == true?Container():
                    ListTile(
