...
import 'package:healthcaredoctor2050/widgets/100ms/common/app_dialogs/audio_device_change_dialog.dart';
import 'package:healthcaredoctor2050/widgets/100ms/common/widgets/hms_embedded_button.dart';
import 'package:healthcaredoctor2050/widgets/100ms/meeting_modes/full_screen_mode.dart';
import 'package:healthcaredoctor2050/widgets/100ms/meeting_modes/audio_mode.dart';
import 'package:healthcaredoctor2050/widgets/100ms/meeting_modes/hero_mode.dart';
import 'package:healthcaredoctor2050/widgets/100ms/meeting_modes/one_to_one_mode.dart';
import 'package:healthcaredoctor2050/widgets/100ms/common/util/app_color.dart';
import 'package:healthcaredoctor2050/widgets/100ms/common/util/utility_components.dart';
...
import 'package:healthcaredoctor2050/widgets/100ms/common/bottom_sheets/more_settings_bottom_sheet.dart';
import 'package:healthcaredoctor2050/widgets/100ms/hls_viewer/hls_player.dart';
import 'package:healthcaredoctor2050/widgets/100ms/meeting/meeting_store.dart';
import 'package:healthcaredoctor2050/widgets/100ms/meeting_modes/basic_grid_view.dart';
import 'package:healthcaredoctor2050/widgets/100ms/common/widgets/pip_view.dart';
import 'package:healthcaredoctor2050/widgets/100ms/model/peer_track_node.dart';
...
class _MeetingPageState extends State<MeetingPage> {
  ...
  late MeetingModeProvider _meetingModeProvider;
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          /// raise hand, meeting chat and live room
                                          Container(
                                                          ...
                                                          (Provider.of<MeetingStore>(context)
                                                              ...
                                                              ? Selector<
                                                                  ...
                                                                  builder: (_,
                                                                      data,
                                                                      __) {
                                                                    return _meetingModeProvider.isAudioOnly ==
                                                                            true
                                                                        ? HMSEmbeddedButton(
                                                                            onTap: () async =>
                                                                                {
                                                                        ...
                                                                        : HMSEmbeddedButton(
                                                                            onTap: () =>
                                                                                {
                                                                              (data.item2) ? null : context.read<MeetingStore>().toggleCameraMuteState(),
                                                                            },
                                                                            width:
                                                                                40,
                                                                            height:
                                                                            ...
                                                                            isActive:
                                                                                data.item1,
                                                                            child: SvgPicture.asset(data.item1 ? "assets/icons/cam_state_on.svg" : "assets/icons/cam_state_off.svg",
                                                                    ...
                                                                    builder: (_, data, __) {
                                                                      return HMSEmbeddedButton(
                                                                        ...
                                                                        child: SvgPicture.asset(
                                                                            ...
                                                                            fit:
                                                                                BoxFit.scaleDown,
                                                                            semanticsLabel: "screen_share_button"),
                                                                      );
                                                                    })
                                                                : Selector<MeetingStore, bool>(
                                                                    ...
                                                                    builder: (_, isBRB, __) {
                                                                      return HMSEmbeddedButton(
                                                                        ...
                                                                        child: SvgPicture.asset(
                                                                            ...
                                                                            fit:
                                                                                BoxFit.scaleDown,
                                                                            semanticsLabel: "brb_button"),
                                                                      );
                                                                    }),
                                                        if (_meetingModeProvider
                                                                .isAudioOnly ==
                                                            false)
                                                          HMSEmbeddedButton(
                                                            onTap: () async => {
